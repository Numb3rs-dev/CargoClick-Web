 ...
 *
 * Fuente: DANE - DIVIPOLA (subregionesColombia.pdf)
 * Fecha: 2026
 * Departamentos: código 2 dígitos
 * Municipios: código 5 dígitos (DD + MMM)
 *
 * Total: 1.119 municipios
 */
...
export interface Municipio {
  ...
  nombre: string;
  /**
   * Controla si el municipio aparece en los selectores de origen/destino.
   * `false` lo oculta sin eliminarlo del catálogo.
   * Omitir (undefined) equivale a `true`.
   */
  visible?: boolean;
}
...
export const DEPARTAMENTOS: Departamento[] = [
  ...
  },
  {
    ...
    municipios: [
      ...
      { codigo: '27135', nombre: 'Cantón de San Pablo' },
      { codigo: '27160', nombre: 'Certeguí' },
  ...
  },
  {
    ...
    municipios: [
      ...
      { codigo: '47745', nombre: 'Sitio Nuevo' },
  ...
  },
  {
    ...
    municipios: [
      ...
      { codigo: '68147', nombre: 'Cambrás' },
      { codigo: '68152', nombre: 'Capitanejo' },
      { codigo: '68160', nombre: 'Carcasí' },
      { codigo: '68162', nombre: 'Cepitá' },
      { codigo: '68167', nombre: 'Cerrito' },
      { codigo: '68169', nombre: 'Charalá' },
      { codigo: '68176', nombre: 'Chima' },
      { codigo: '68179', nombre: 'Chipatá' },
      { codigo: '68190', nombre: 'Cimitarra' },
      { codigo: '68207', nombre: 'Concepción' },
      { codigo: '68211', nombre: 'Confines' },
      { codigo: '68217', nombre: 'Contratación' },
      { codigo: '68229', nombre: 'Coromoro' },
      { codigo: '68235', nombre: 'Curití' },
      { codigo: '68245', nombre: 'El Carmen de Chucurí' },
      { codigo: '68250', nombre: 'El Guacamayo' },
      { codigo: '68255', nombre: 'El Peñón' },
      { codigo: '68264', nombre: 'El Playón' },
      { codigo: '68266', nombre: 'Encino' },
      { codigo: '68271', nombre: 'Enciso' },
      { codigo: '68276', nombre: 'Florián' },
      { codigo: '68296', nombre: 'Floridablanca' },
      { codigo: '68298', nombre: 'Galán' },
      { codigo: '68307', nombre: 'Gámbita' },
      { codigo: '68318', nombre: 'Girón' },
      { codigo: '68320', nombre: 'Guaca' },
      { codigo: '68322', nombre: 'Guadalupe' },
      { codigo: '68324', nombre: 'Guapotá' },
      { codigo: '68327', nombre: 'Guavatá' },
      { codigo: '68344', nombre: 'Güepsa' },
      { codigo: '68368', nombre: 'Hato' },
      { codigo: '68370', nombre: 'Jesús María' },
      { codigo: '68377', nombre: 'Jordán' },
      { codigo: '68385', nombre: 'La Belleza' },
      { codigo: '68397', nombre: 'Landázuri' },
      { codigo: '68406', nombre: 'La Paz' },
      { codigo: '68418', nombre: 'Lebrija' },
      { codigo: '68425', nombre: 'Los Santos' },
      { codigo: '68432', nombre: 'Macaravita' },
      { codigo: '68444', nombre: 'Málaga' },
      { codigo: '68464', nombre: 'Matanza' },
      { codigo: '68468', nombre: 'Mogotes' },
      { codigo: '68498', nombre: 'Molagavita' },
      { codigo: '68500', nombre: 'Nariño' },
      { codigo: '68522', nombre: 'Ocamonte' },
      { codigo: '68533', nombre: 'Oiba' },
      { codigo: '68547', nombre: 'Onzaga' },
      { codigo: '68549', nombre: 'Palmar' },
      { codigo: '68551', nombre: 'Palmas del Socorro' },
      { codigo: '68572', nombre: 'Puente Nacional' },
      { codigo: '68573', nombre: 'Páramo' },
      { codigo: '68575', nombre: 'Piedecuesta' },
  ...
  },
  {
    ...
    municipios: [
      ...
      { codigo: '70233', nombre: 'El Palmito' },
  ...
  },
  {
    ...
    municipios: [
      ...
      { codigo: '73616', nombre: 'Rio Blanco' },
 ...
 *
 * @param soloVisibles - Si `true` (por defecto) filtra municipios con `visible === false`.
 *   Pasar `false` para obtener el catálogo completo sin filtrar.
 */
export function getAllMunicipios(soloVisibles = true): MunicipioOption[] {
  return DEPARTAMENTOS.flatMap((depto) =>
    depto.municipios
      .filter((mun) => !soloVisibles || mun.visible !== false)
      .map((mun) => ({
        codigo: mun.codigo,
        nombre: mun.nombre,
        depto: depto.nombre,
...
/**
 * Retorna todos los municipios, incluyendo los ocultos.
 * Útil para administración o reportes internos.
 */
export function getAllMunicipiosSinFiltro(): MunicipioOption[] {
  return getAllMunicipios(false);
}
