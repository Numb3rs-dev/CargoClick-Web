...
export const actualizarSolicitudSchema = z.object({
  ...
  tipoCarga: z.enum(['CARGA_GENERAL', 'REFRIGERADA', 'CONTENEDOR', 'GRANEL_SOLIDO', 'GRANEL_LIQUIDO']).optional(),
...
export const solicitudCompletaSchema = z
  .object({
    ...
    destino: z.string().min(3).max(200).trim().optional(),
    tipoCarga: z.enum(['CARGA_GENERAL', 'REFRIGERADA', 'CONTENEDOR', 'GRANEL_SOLIDO', 'GRANEL_LIQUIDO']),
